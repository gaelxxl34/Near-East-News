...
<head>
 ...
 <!-- Customized Bootstrap Stylesheet -->
    ...
    <style>
    .article-container {
        height: 350px; /* Set this value according to your design requirements */
        overflow: hidden;
    }
</style>
</head>
                            ...
                            @foreach ($articles as $article)
                                <div class="position-relative " >
                                    ...
                                    <div class="overlay position-relative bg-light">
                                        ...
                                        <a style="font-family: 'Montserrat';" class="h4 m-0" href="{{ route('welcome.full-article', ['articleId' => $article['id']]) }}">{{ $article['title'] }}</a>
                                    </div>
                                </div>
                            @endforeach
                        </div>
