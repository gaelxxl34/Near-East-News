                                    ...
                                    <div class="d-flex justify-content-center justify-content-lg-start">
                                        ...
                                        <div class="card custom-card" style="width: 100%;">
                                            ...
                                            <div class="card-footer d-flex justify-content-between align-items-center border-0">
                                                <!-- First Button: Pending -->
                                                <button type="button" class="btn btn-sm btn-warning">
                                                    Pending <i class="fas fa-clock"></i>
                                                </button>

                                                <!-- Second Button: Read More -->
                                                <a href="{{ route('journalist.full-pending-article', ['articleId' => $article['id']]) }}" class="btn btn-sm btn-primary">Read more <i class="fas fa-arrow-right"></i></a>
