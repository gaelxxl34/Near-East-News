                    ...
                    <div class="container mt-3 mb-3 d-flex justify-content-center align-items-center">
                        <div class="card custom-card">
                            ...
                            <div class="card-footer d-flex justify-content-between align-items-center border-0">
                                ...
                                <button class="btn btn-sm btn-success" onclick="confirmPublish('{{ $article['id'] }}')">
                                    Remove From Published <i class="fas fa-check-circle"></i>
                                </button>
...
<script>
    ...
    if (confirm('Are you sure you want to remove this article from published list?')) {
        // Send request to Laravel route
        window.location.href = `/unpublish-article/${articleId}`;
    }
}
