...
@section('content')
    ...
    <div class="main">
        ...
        <nav class="navbar navbar-expand px-2 border-bottom d-flex justify-content-between">
            ...
            <h5  style="color: black">Edit Journalist Data</h5>
                ...
                <div class="d-flex justify-content-center align-items-center">
                    <div class="card custom-card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.update-journalist-data', ['journalistId' => $journalist['id']]) }}" enctype="multipart/form-data" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-3">
                                    ...
                                    @if ($journalist['profile_picture'])
                                        <img src="{{ $journalist['profile_picture'] }}" alt="Current Image" style="max-height: 200px;">
                                    @endif
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="firstName" name="firstName" value="{{ $journalist['firstName'] }}" required>
                                </div>

                                <!-- Last Name -->
                                <div class="mb-3">
                                    <label for="lastName" class="form-label">Last Name</label>
                                    <input type="text" class="form-control" id="lastName" name="lastName" value="{{ $journalist['lastName'] }}" required>
                                </div>

                                <!-- Email -->
                                <div class="mb-3">
                                    <label for="email" class="form-label">Email Address</label>
                                    <input type="email" class="form-control" id="email" name="email" value="{{ $journalist['email'] }}" required>
                                </div>


                                <!-- Update Button -->
                                <button type="submit" class="btn btn-primary mb-2" onclick="return confirm('Are you sure you want to update the journalist data?')">Update</button>
